        ...
        return (
            <header>
                <div className="header row">
                    <Link to={'/chat/main'} style={{backgroundImage: 'url('+ require("../../img/logo.png")+')'}} className='logo col-5 col-md-3'></Link>
                    <div className="profile-block col-4 offset-3  col-md-2 offset-md-7">
